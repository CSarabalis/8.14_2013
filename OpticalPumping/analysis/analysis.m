...
%tableB [ Current in the X [mA], Current in the Y [mA], Current in the Z [mA], Magnetic Field as Measured by the Magnetometer [mG], Resonance Frequency of the First Peak [ms], Resonance Frequency of the Second Peak [ms]
