...
% Fit hyperbolas
x=y_mag_field(yrange);
y=peak_1_freq(yrange);
sig=instr_uncert(yrange);
...
clear yrange y_mag_field xlab ylab tit x y sig function_hyperbola
...
clear xrange x_mag_field xlab ylab tit x y sig function_hyperbola
