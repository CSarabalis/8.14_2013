...
tit='Resonance peak movement as Y-coil current varies: Peak 1';

fitnonlin(xlab,x,ylab,y,tit,sig,function_hyperbola,a0)

%Peak2
y = peak_2_freq(yrange(i));
a0=[87 0.11 0.06 1.4];

xlab='Magnetic field generated by Y-coil [G]';
ylab='Resonance frequency of absorption peaks [kHz]';
tit='Resonance peak movement as Y-coil current varies: Peak 2';
